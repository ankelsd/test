...
<div class="container-custom">
		<div class="row">
			...
			<div class="table-hdng d-flex align-items-center justify-content-between tble-ttle welcome-txts">
                <form method="POST" action="{{route('contact_store')}}" name="client_module" id="client_module" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="contact_name" id="contact_name"  value=""  class="clsCompCode form-control"  >
                                            <input type="hidden" name="customer_id" id="customer_id" value="{{ $id }}" >

                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Contact Number</label>
                                            <input type="text" name="contact_number" id="contact_number"  value=""  class="clsCompName form-control" >
