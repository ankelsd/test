...
function menuhrres() {
    $(window)[0].innerWidth < 992 ? setTimeout(function() {
        ...
        $(".pcoded-navbar").hasClass("theme-horizontal-dis") && ($(".sidenav-horizontal-wrapper-dis").css({
            height: "100%",
            position: "relative"
        }), $(".sidenav-horizontal-wrapper-dis")[0]) && new PerfectScrollbar(".sidenav-horizontal-wrapper-dis", {
            wheelSpeed: .5,
            swipeEasing: 0,
            suppressScrollX: !0,
            wheelPropagation: 1,
...
function togglemenu() {
    ...
    0 == $(".pcoded-navbar").hasClass("theme-horizontal") && (e <= 1200 && e >= 992 && $(".pcoded-navbar:not(.theme-horizontal)").addClass("navbar-collapsed"), e < 992 && $(".pcoded-navbar:not(.theme-horizontal)").removeClass("navbar-collapsed"))
}
...
function togglemenulayout() {
    var e = $(window)[0].innerWidth;
    ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) && (e <= 1200 && e >= 992 && $(".pcoded-navbar:not(.theme-horizontal)").addClass("navbar-collapsed"), e < 992 && $(".pcoded-navbar:not(.theme-horizontal)").removeClass("navbar-collapsed"))
}
...
$(document).ready(function() {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function() {
            ...
            $(".pcoded-inner-navbar > li").each(function() {
                ...
                if (d) {
                    -1 !== d.indexOf(e) ? $(this).show() : $(this).hide(), s > 0 ? $(".pcoded-menu-caption").hide() : $(".pcoded-menu-caption").show()
                }
            })
            ...
            width: "60px"
        })), $(".main-friend-cont")[0] && $(".main-friend-cont").each(function() {
...
if ($(window).scroll(function() {
        ...
        var s = (this.attr("id"), {
            ...
            o = {
                PcodedMenuInit: function() {
                    o.HandleMenuTrigger(), o.HandleSubMenuTrigger(), o.HandleOffset()
                },
                HandleSubMenuTrigger: function() {
                    ...
                    if (1 == $(".pcoded-navbar").hasClass("theme-horizontal") || 1 == $(".pcoded-navbar").hasClass("theme-horizontal-dis"))
                        if (o >= 992 && $("body").hasClass("layout-6") || o >= 992 && $("body").hasClass("layout-7")) {
                            ...
                            d.off("click").off("mouseenter mouseleave").hover(function() {
                        ...
                        if (!$(".pcoded-navbar").hasClass("theme-horizontal-dis")) {
                            ...
                            d.off("mouseenter mouseleave").off("click").on("click", function() {
        ...
        ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) && setTimeout(function() {
            s <= 992 && $(".pcoded-navbar:not(.theme-horizontal-dis)").removeClass("mob-open"), s > 992 && ($(".pcoded-navbar:not(.theme-horizontal)").toggleClass("mob-open"), e.stopPropagation())
        }, 100)
    }), $("#show-toggle").on("click", function() {
        $(".pcoded-navbar:not(.theme-horizontal-dis)").toggleClass("mob-open-h")
    }), ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) && $(".navbar-content")[0]) var px = new PerfectScrollbar(".navbar-content", {
    wheelSpeed: .5,
    swipeEasing: 0,
    suppressScrollX: !0,
    wheelPropagation: 1,
...
$(".pcoded-header > .collapse:not(.show) .mob-toggler").click(function() {
...
}), vw >= 992 && $(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").unbind("click"), $(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").on("mouseenter", function() {
    if (vw >= 992) {
        clrpop(), $(".navbar-wrapper").append('<div class="navbar-popup"></div>');
        var e = $(this),
            s = $(".navbar-popup"),
            o = e.children(".pcoded-submenu").clone();
        s.addClass("pcoded-inner-navbar"), s.html(o);
        var d = $(e, this),
            a = d.offset(),
            i = (a.left, a.top),
            ...
            r = s.innerHeight();
        s.show(), console.log(t), n <= i + r - t ? (s.addClass("vedge"), s.animate({
            top: i - 240 - t
        }, 1)) : (s.removeClass("vedge"), s.animate({
            top: i - 8 - t
        }, 1)), $(".navbar-popup > .pcoded-submenu").css({
            "max-height": "300px",
            position: "relative"
        });
    ...
    if (!$("body").hasClass("layout-14") && this.href == e && "" != $(this).attr("href") && ($(this).parent("li").addClass("active"), $(".pcoded-navbar").hasClass("theme-horizontal") || ($(this).parent("li").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger"), $(this).parent("li").parent().parent(".pcoded-hasmenu").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger")), ($("body").hasClass("layout-7") || $("body").hasClass("layout-6")) && ($(this).parent("li").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger"), $(this).parent("li").parent().parent(".pcoded-hasmenu").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger"), $(".theme-horizontal .pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger")), $(this).parent("li").parent().parent(".sidelink").addClass("active"), $(this).parent("li").parent().parent().parent().parent(".sidelink").addClass("active"), $(this).parent("li").parent().parent().parent().parent().parent().parent(".sidelink").addClass("active"), $("body").hasClass("layout-1") || $("body").hasClass("layout-9"))) {
        var s = $(".sidelink.active").attr("class");
        s = s.replace("sidelink", ""), s = s.replace("active", ""), $(".sidemenu  .nav-link[data-cont=" + s.trim() + "]").parent().addClass("active")
    }
});
...
if ($(".pcoded-submenu li").hasClass("active")) {
	$(".pcoded-submenu li.active").parent().parent().addClass("pcoded-trigger");
}
