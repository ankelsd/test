    ...
    */
    ...
    var TableBlockEvent = /** @class */ (function (_super) {
        ...
        TableBlockEvent.prototype.render = function () {
            var props = this.props;
            // var classcolor = 'btn-ot-bk';
            // //console.log(props.seg.eventRange.def.extendedProps.status);
            // if(props.seg.eventRange.def.extendedProps.status=='0'){
            //     classcolor = 'btn-pl-bk';
            // }else if(props.seg.eventRange.def.extendedProps.status=='1'){
            //     classcolor = 'btn-fl-bk';
            // }else if(props.seg.eventRange.def.extendedProps.status=='2'){
            //     classcolor = 'btn-ot-bk';
            // }else if(props.seg.eventRange.def.extendedProps.status=='3'){
            //     classcolor = 'btn-ct-bk';
            // }else if(props.seg.eventRange.def.extendedProps.status=='4'){
            //     classcolor = 'btn-cl-bk';
            // }else if(props.seg.eventRange.def.extendedProps.status=='5'){
            //     classcolor = 'btn-ot-bk';
            // }
            //if(props.eventRange.def)
            return (createElement(StandardEvent, __assign({}, props, { extraClassNames: ['fc-daygrid-event', 'fc-daygrid-block-event', 'fc-h-event'], defaultTimeFormat: DEFAULT_TABLE_EVENT_TIME_FORMAT, defaultDisplayEventEnd: props.defaultDisplayEventEnd, disableResizing: !props.seg.eventRange.def.allDay, backgroundColor: '#000000' })));
        };
